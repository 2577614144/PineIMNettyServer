...
public final class MessageProtobuf {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int BYTESFILE_FIELD_NUMBER = 9;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + BYTESFILE_FIELD_NUMBER;
    ...
    public static final class Builder extends
      ...
      // Construct using com.pine.im.protobuf.MessageProtobuf.Head.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
  ...
  static {
    ...
    internal_static_Head_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_Head_descriptor,
        new String[] { "MsgId", "MsgType", "MsgContentType", "FromId", "ToId", "Timestamp", "StatusReport", "Extend", "BytesFile", });
  }
